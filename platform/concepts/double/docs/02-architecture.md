...
|---|---|---|---|---|---|---|
| `phone` | Получить код | элемент экрана | открывает экран | Код (code) | — | — |
| `phone` | Помощь | элемент экрана | показывает подтверждение «Помощь · double.fit/help» | остаётся на экране | — | — |
| `phone` | Поддержка | элемент экрана | показывает подтверждение «Поддержка · support@double.fit» | остаётся на экране | — | — |
...
| `code` | Код 0000 | элемент экрана | открывает экран | Неверный код (codefail) | — | — |
| `code` | Продолжить | элемент экрана | открывает экран | Бесплатные наборы (ads) | — | — |
| `codefail` | Назад | кнопка «назад» | возвращает к родительскому экрану | Код (code) | — | — |
| `ads` | Назад | кнопка «назад» | возвращает к родительскому экрану | Код (code) | — | — |
