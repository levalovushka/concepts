...
| Вход по номеру телефона и SMS-код | SDK провайдера аутентификации (VK ID / Firebase Phone Auth). Свой сервер не поднимаем; на устройстве — только токен в Keychain |
