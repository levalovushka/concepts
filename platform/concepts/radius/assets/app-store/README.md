# Радиус — App Store assets

Сгенерировано из живого прототипа командой `npm run app-store -- radius`.

- Локаль: ru-RU
- Шаблон полного экспорта: studio
- Кадров в серии: 5
- Размеры: iPhone 6.9″ 1320×2868, iPhone 6.5″ 1284×2778, iPhone 6.3″ 1206×2622, iPhone 6.1″ 1170×2532, iPad 13″ 2752×2064
