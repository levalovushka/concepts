# Эстафета — карта экранов и архитектура

Заполняется по PLAYBOOK.md. Блоки `@generated:*` пересобираются командой `npm run docs -- estafeta` — внутрь них руками не пишем.
