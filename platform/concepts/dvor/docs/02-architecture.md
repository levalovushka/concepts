...
Регистрация по почте (phone) — старт, без таб-бара · открывается: старт
    └─ Найдите свой дом (join) — push · открывается: «Создать аккаунт» · location
...
|---|---|---|---|---|---|---|
| `phone` | Создать аккаунт | элемент экрана | открывает экран | Найдите свой дом (join) | — | — |
| `phone` | Помощь | элемент экрана | показывает подтверждение «Помощь · dvor.app/help» | остаётся на экране | — | — |
