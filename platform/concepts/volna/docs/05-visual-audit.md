...
>
> Добавлены позже: `background`. Сейчас в концепте **10 экранов** и **2 доступа**; актуальный состав — в генерируемых блоках `02-architecture.md`. Последний прогон `npm run audit -- volna` — чисто.
