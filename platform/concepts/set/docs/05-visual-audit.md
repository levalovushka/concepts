...
>
> Добавлены позже: `background`, `codefail`. Сейчас в концепте **17 экранов** и **5 доступов**; актуальный состав — в генерируемых блоках `02-architecture.md`. Последний прогон `npm run audit -- set` — чисто.
