...
assert.equal(IPHONE_COMPOSITION.copyTop, 260, 'крупная типографика должна заполнять верх кадра');
assert.equal(IPHONE_COMPOSITION.headlineSize, 124);
assert.equal(IPHONE_COMPOSITION.bodySize, 54);
