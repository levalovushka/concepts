...
if (!input) {
  console.error("usage: npm run native:v2 -- native/ConceptSpecs/<concept>.json [--review review.json]");
  process.exit(1);
}
...
const result = generateNativeConceptV2({ projectRoot: NATIVE_PROJECT_ROOT, spec, visualReview });
