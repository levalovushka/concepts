...
import { normalizeLeanActionEffects } from "./lib/structured-model-lean-architect.mjs";
...
const blueprint = normalizeLeanActionEffects(
  JSON.parse(readFileSync(blueprintPath, "utf8")),
  { force: process.argv.includes("--refresh-effects") },
);
