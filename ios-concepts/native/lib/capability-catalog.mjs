...
export const IOS_CAPABILITY_CATALOG = Object.freeze({
  ...
  push: {
    ...entitlement("aps-environment", "development", "UserNotifications", "notifications"),
    activation: "contextual-gesture",
  },
  commnotif: {
  ...
  audio: { ...background("audio", "AVFoundation", "backgroundAudio"), activation: "contextual-gesture" },
  voip: { ...background("voip", "CallKit", "voip"), activation: "contextual-gesture" },
  ...
  applesignin: {
    ...entitlement("com.apple.developer.applesignin", ["Default"], "AuthenticationServices", "signInWithApple"),
    activation: "contextual-gesture",
  },
...
export function resolveCapability(permissionKey, buildContext) {
  ...
  return {
    ...
    activation: definition.activation || "contextual-gesture",
  };
}
