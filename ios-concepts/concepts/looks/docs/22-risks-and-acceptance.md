...
- claim: Доход с активного сообщества покрывает модерацию, не снижая долю органических сохранений и самостоятельных публикаций; risk: medium; validation: Посчитать реальные операционные издержки после подтверждения core loop; status: needs-validation
